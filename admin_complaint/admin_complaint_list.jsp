...
<head>
    ...
    <title>민원답변목록 | 관리자페이지 | 영등포본동 주민센터</title>
                ...
                <main>
                    ...
                    <div class="location">
                        ...
                        <div class="location_path">
                            ...
                            <span class="loc_arrow">></span>
                            <span class="loc_text">
                                <a href="civil_complaint_list.html">민원답변 목록</a>
                            </span>
                        </div>
                    ...
                    <div id="board" class="clearfix">
                        ...
                        <table class="p_table">
                            ...
                            <tbody class="tb_text">
                                <tr>
                                    <td>15</td>
                                    <td class="p_sub"><a href="civil_complaint_view.html">지하철역 미화개선</a></td>
                        ...
                        <div class="board_btm_btns">
                            <a href="civil_complaint_write.html" class="btn btn_write">글쓰기</a>
                        </div>
                    </div>
                    <!-- //contents -->
