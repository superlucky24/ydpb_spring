                                ...
                                <table class="table_form">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="comTitle" id="comTitle" class="input form_input" maxlength="300" value="지하철역 미화개선" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">
                                            ...
                                            <td>
                                                <textarea name="comcontent" id="comcontent" class="input" rows="10" maxlength="4000" required>구로디지탈단지역 계단이 미끄럽고 보기에 너무 안 좋습니다
...
원광디지털대학교-지밸리로 이어지는 인도 바로 옆에 도로라 우천, 폭설시 너무 위험합니다</textarea>
                                ...
                                <div class="btns">
                                    <a href="community_center_list.html" class="btn btn_default">목록</a>
                                    <input type="submit" class="btn btn_write" value="저장">
                                    <input type="reset" class="btn btn_cancel" value="삭제">
                                </div>
                            </form>
                        </div>
                    </div>
